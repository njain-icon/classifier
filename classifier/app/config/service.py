...
from classifier.app.exceptions.exception_handler import exception_handlers


with redirect_stdout(StringIO()), redirect_stderr(StringIO()):
    from classifier.app.routers.routers import api_v1_router_instance
    
from classifier.log import get_logger, get_uvicorn_logconfig
...
class Service:
    ...
    def start(self):
        logger.info(f"Starting Classifier Server with config {self.config_details}")
